...
def test_null_coordinates():
    with pytest.raises(ValueError):
      coord = Coordinate.from_string("9.9.9/9.9.9/9.9.9")

def test_null_library():
    with pytest.raises(ValueError):
      coord = Coordinate.from_string("9.1.1/1.1.1/1.1.1")

def test_null_shelf():
    with pytest.raises(ValueError):
      coord = Coordinate.from_string("1.9.1/1.1.1/1.1.1")

def test_null_series():
    with pytest.raises(ValueError):
      coord = Coordinate.from_string("1.1.9/1.1.1/1.1.1")

def test_null_collection():
    with pytest.raises(ValueError):
      coord = Coordinate.from_string("1.1.1/9.1.1/1.1.1")

def test_null_volume():
    with pytest.raises(ValueError):
      coord = Coordinate.from_string("1.1.1/1.9.1/1.1.1")

def test_null_book():
    with pytest.raises(ValueError):
      coord = Coordinate.from_string("1.1.1/1.1.9/1.1.1")

def test_null_chapter():
    with pytest.raises(ValueError):
      coord = Coordinate.from_string("1.1.1/1.1.1/9.1.1")

def test_null_section():
    with pytest.raises(ValueError):
      coord = Coordinate.from_string("1.1.1/1.1.1/1.9.1")

def test_null_scroll():
    with pytest.raises(ValueError):
      coord = Coordinate.from_string("1.1.1/1.1.1/1.1.9")
